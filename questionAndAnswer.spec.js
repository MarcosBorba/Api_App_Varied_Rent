...
describe('Test QuestionsAndAnswerAd Test', () => {
    ...
    it('Updating email', (done) => {
        let testUpdateQuestionAndAnswerAd = {
            _id: idQuestionAndAnswerTest,
            _ad_fk: "5f6662d74f4b5021684a010c",
            _tenant_fk: "5fbe6c853f9f3d34147c7027",
            question: {
                tenant_name: "Maria Teixeira",
            ...
            answer: {
                locator_name: "teste teste",
                locator_email: "test@gmail.com",
                answer_date_time: "2020-11-27",
                answer: "test question update",
            },
        }

        chai.request(base_url)
            .put('/questionAndAnswerRoute/update_question_and_answer_one_ad')
            .query(testUpdateQuestionAndAnswerAd)
            .end((err, res) => {
